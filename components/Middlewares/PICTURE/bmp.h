...
/* 函数声明 */
uint8_t bmp_decode(const char *filename, int width, int height);                                            /* BMP解码 */
uint8_t bmp_encode(uint8_t *filename, uint16_t *image_addr, uint16_t width, uint16_t height, uint8_t mode); /* BMP编码 */
